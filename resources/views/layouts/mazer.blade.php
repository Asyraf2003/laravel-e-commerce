            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="#" class="fs-4 fw-bold text-decoration-none">Dashboard</a>
                        </div>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.reviews.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.reviews.index') }}" class='sidebar-link'>
                                ...
                                <span>Kelola Review Produk</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.carts.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.carts.index') }}" class='sidebar-link'>
                                ...
                                <span>Kelola Keranjang User</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ request()->routeIs('admin.checkout.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.checkout.index') }}" class='sidebar-link'>
                                <i class="bi bi-cart-fill"></i>
                                <span>Kelola Checkout User</span>
                            </a>
                        </li>                        
